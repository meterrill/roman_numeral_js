var romanNumeral = function(number) {
  if (parseInt(number) < 4000) {
    ...
    return "Roman numerals max out at 3999";
  }
};

$(document).ready(function() {
  $("form#arabic-number").submit(function(event) {
    var number = $("input#number").val();
    var romanNumeralString = romanNumeral(number);

    $(".roman-numeral").text(romanNumeralString);
